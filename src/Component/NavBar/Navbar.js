...
const closedMixin = (theme) => ({
  ...
  overflowX: 'hidden',
  width: `calc(${theme.spacing(0)} + 1px)`, // Hidden Left side icon
...
const LeftAppBar = styled(MuiAppBar, {
...
const ButtonTK = styled('div')(({ theme }) => ({
  position: 'relative',
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <LeftAppBar position="fixed" open={open}>
          <Toolbar>
            ...
            {/* -----------------add search and profile bar satrt  */}
            <Search
              sx={{
            ...
            {/* -----------------add search and profile bar End  */}
          </Toolbar>
